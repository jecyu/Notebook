 ...
 * @LastEditors: Jecyu
 * @LastEditTime: 2021-02-23 16:11:37
 * @FilePath: /examples/18-dataStructure/tree/trasverse.js
 * @Description: 树的遍历
 */
...
// trasverBFC(tree, node => { console.log(node.title) })
