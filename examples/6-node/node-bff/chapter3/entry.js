...
app.use(mount("/download", require("./1.download/index")));
app.use(mount("/detail", require("./2.detail/index"))); // 传入一个 koa 实例
app.use(mount("/play", require("./3.play/index")));
// app.use(mount("/list", require("./4.list/node/index")));
app.use(mount("/list", require("./4.list/node/index")));
